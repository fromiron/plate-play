...
import { Palette, X, Heart, RotateCcw } from "lucide-react";
import {
  isValidHexColor,
  hexToRgb,
  rgbToHex,
...
// 미리 정의된 색상 팔레트
const PRESET_COLORS = [
  "#16a34a", "#0ea5e9", "#f59e0b", "#dc2626", "#9333ea",
  "#e11d48", "#059669", "#0891b2", "#ca8a04", "#b91c1c",
  "#7c3aed", "#be123c", "#065f46", "#0c4a6e", "#92400e",
  "#991b1b", "#581c87", "#9f1239", "#064e3b", "#1e3a8a",
];
          ...
          {inputMode === 'hex' && (
            <div className="space-y-2">
              ...
              {!isValidHexColor(hexInput) && hexInput && (
                <p className="text-sm text-red-500">유효하지 않은 Hex 코드입니다.</p>
              )}
            </div>
          )}
