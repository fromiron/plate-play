							...
							<div className="space-y-2">
								<ColorPicker
									...
									onChange={(color) =>
										update((p) => ({
											...p,
											theme: { ...(p.theme ?? {}), primary: color },
										}))
									}
									label="Primary"
									open={activeColorPicker === "primary"}
									onOpenChange={(open) =>
										setActiveColorPicker(open ? "primary" : null)
									}
								/>
								<ColorPicker
									...
									onChange={(color) =>
										update((p) => ({
											...p,
											theme: { ...(p.theme ?? {}), secondary: color },
										}))
									}
									label="Secondary"
									open={activeColorPicker === "secondary"}
									onOpenChange={(open) =>
										setActiveColorPicker(open ? "secondary" : null)
									}
								/>
								<ColorPicker
									...
									onChange={(color) =>
										update((p) => ({
											...p,
											theme: { ...(p.theme ?? {}), accent: color },
										}))
									}
									label="Accent"
									open={activeColorPicker === "accent"}
									onOpenChange={(open) =>
										setActiveColorPicker(open ? "accent" : null)
									}
								/>
							</div>
							<Button
