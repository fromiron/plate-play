...
export function sampleBoard(): MenuBoard {
  ...
  return {
    id,
    title: { default: "Plate Play 샘플 메뉴", en: "Plate Play Sample Menu", zh: "Plate Play 示例菜单" },
    description: { default: "처음 시작을 위한 예시 메뉴입니다.", en: "A starter example menu.", zh: "入门示例菜单。" },
    currency: "KRW",
    defaultLang: "default",
    theme: {
      primary: "#16a34a",
    ...
    promotions: [{ id: nanoid(6), name: "해피 아워", percent: 15, startHour: 15, endHour: 17, days: [1, 2, 3, 4, 5] }],
    createdAt: now,
    updatedAt: now,
    sections: [
      {
        ...
        items: [
          {
            id: nanoid(8),
            name: { default: "스테이크 플래터", en: "Steak Platter", zh: "牛排拼盘" },
            description: {
          ...
          },
          {
            ...
            description: { default: "베이컨과 양송이 버섯", en: "Bacon and mushrooms", zh: "培根和蘑菇" },
            price: 16000,
      ...
      },
      {
        ...
        items: [
          {
            id: nanoid(8),
            name: { default: "시저 샐러드", en: "Caesar Salad", zh: "凯撒沙拉" },
            description: {
